            ...
            <div className="relative group">
              ...
              <div className="relative flex flex-col sm:flex-row gap-3 p-1 bg-black rounded-xl border border-white/10 z-10">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-transparent text-white placeholder-gray-500 focus:outline-none text-sm sm:text-base w-full sm:w-auto"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-5 py-2.5 text-sm sm:text-base bg-brand-red text-white font-semibold rounded-lg hover:bg-brand-red/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                >
                  {formState === 'loading' ? (
