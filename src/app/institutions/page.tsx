...
const HERO: Record<Tab, { eyebrow: string; title: string; sub: ReactNode; ctaHref: string; ctaLabel: string; meta: string }> = {
  ...
  businesses: {
    ...
    title: 'Bring out the best in human and AI work.',
    sub: (
      <>
        AI is now in every deliverable, and leadership is asking about the value.{' '}
        <em className="italic">Workings</em> is a verifiable record of how it was used and where your
        people added value. It&apos;s stored securely and shared only when your team chooses. So when
        your CFO, a client, or a regulator asks, you answer with evidence.
      </>
    ),
...
// Applications matrix on the business page — grouped use-cases. Bullets
// are ReactNode so we can italicise `Workings` mid-sentence where it
// appears.
const BIZ_APPLICATIONS: {
...
}[] = [
  {
    ...
    bullets: [
      ...
      'Demonstrate continuous supervision of AI use by junior and support staff (for legal firms) with a tool that makes AI use clearly identifiable.',
    ],
  },
  {
    title: 'Trusted Work',
    bullets: [
      'Catch AI hallucinations, errors, and unsupported claims before they reach a client, by seeing where AI was used and whether it was checked.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Eliminate subscriptions for applications no one uses by understanding which tools staff actually use.',
      'Streamline recruitment by reducing spam and understanding how applications were constructed.',
      'Improve staff efficiency with a tool that lets them search their entire workflow history instantly: find any document, message, or webpage seen or worked on.',
    ],
  },
  {
    title: 'Proven Pitches',
    bullets: [
      ...
      'Differentiate pitches by showing prospective clients your process is verifiable, not just stated.',
      "Demonstrate the human craft behind a deliverable to clients who need to know it wasn't AI-generated.",
    ],
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
            {BIZ_APPLICATIONS.map((group, idx) => (
              ...
              >
                ...
                <h3 className="font-display text-[1.4rem] sm:text-[1.65rem] leading-[1.12] text-navy mb-7">
                  {group.title}
                </h3>
